...
class MathSubtract : UIViewController, UITextFieldDelegate {
    ...
    override func viewDidLoad() {
        ...
        if(level<6){
            randtwo = level
            randone = randomInt(randtwo, max: randtwo+9)
        }
        else if(level==6){
            randtwo = randomInt(1, max: 5)
            randone = randomInt(randtwo, max: 10)
        }
        else if(level<12){
            randtwo = level - 1
            randone = randomInt(randtwo, max: randtwo+9)
    ...
    @IBAction func submitted(sender: AnyObject) {
        if (((timerCount > 0 && test) || (total<=PQuestions && practice)) && answer.text!.isEmpty != true) {
            ...
            if(level<6){
                randtwo = level
                var randoneT = randomInt(randtwo, max: randtwo+9)
                if(randoneT==randone){
                    randone = randoneT++
                }
                else{
                ...
                randtwo = randomInt(1, max: 5)
                var randoneT = randomInt(randtwo, max: 10)
                if(randoneT==randone){
                    randone = randone++
                }
                else{
                ...
                randtwo = randomInt(6, max: 10)
                var randoneT = randomInt(randtwo, max: randtwo + 10)
                if(randoneT==randone){
                    randone = randone++
                }
                else{
                ...
                randtwo = randomInt(1, max: 20)
                var randoneT = randomInt(randtwo, max: randtwo+29)
                if(randoneT==randone){
                    randone = randone++
                }
                else{
    ...
    override func prepareForSegue(segue: UIStoryboardSegue, sender: AnyObject?) {
        ...
        let myStringH = defaults.valueForKey("highScoreSubtract") as? String
        let x : Int = total
        ...
        if (segue.destinationViewController.isKindOfClass(OverSubtract)) {
            ...
            let DestViewController : OverSubtract = segue.destinationViewController as! OverSubtract
            if(test){
            ...
            timer.invalidate()
            let DestViewController : OptionsSubtract = segue.destinationViewController as! OptionsSubtract
