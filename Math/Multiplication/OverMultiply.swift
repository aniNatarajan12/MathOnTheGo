...
class OverMultiply : UIViewController {
    ...
    override func viewDidLoad() {
        ...
        if let checker = levelStuff.valueForKey("levelS") as? String{
            ...
            levelStuff.setObject("\(S)", forKey: "levelS")
            levelStuff.synchronize()
        }
    ...
    override func prepareForSegue(segue: UIStoryboardSegue, sender: AnyObject?){
        ...
        if(segue.destinationViewController.isKindOfClass(ChosenMultiply)){
            ...
            DestViewController.mode = "multiplication"
            DestViewController.PQuestions = PQuestions
            DestViewController.sound = sound
