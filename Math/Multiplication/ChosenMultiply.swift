...
class ChosenMultiply: UIViewController {
    ...
    @IBAction func practicePressed(sender: AnyObject) {
        practice = true
        self.performSegueWithIdentifier("goToNextPageM", sender: self)
    }
    ...
    override func prepareForSegue(segue: UIStoryboardSegue, sender: AnyObject?) {
        if (segue.destinationViewController.isKindOfClass(MathMultiply)) {
            ...
            DestViewController.levelStuff.setObject("\(level)", forKey: "levelM")
